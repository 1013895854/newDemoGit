...
function a(b, c, d) {
    ...
    7 : [function(a, b, c) {
        ...
        i = d.extend({
            ...
            bindEvent: function() {
                ...
                f.on(b, "click",
                function() {
                    a._player._changeStream && a._switchUrl && a._player._changeStream(a._switchUrl.index, g.get("Quality_Change_Text")),
                    e.css(a.el(), "display", "none")
                });
    ...
    8 : [function(a, b, c) {
        ...
        k = d.extend({
            init: function(a, b) {
                d.call(this, a, b),
                this.className = b.className ? b.className: "prism-liveshift-progress",
                this.addClass(this.className),
                this._liveshiftService = a._liveshiftService
            },
            createEl: function() {
                var a = d.prototype.createEl.call(this);
                return a.innerHTML = '<div class="prism-enable-liveshift"><div class="prism-progress-loaded"></div><div class="prism-progress-played"></div><div class="prism-progress-cursor"></div><p class="prism-progress-time"></p><div class="prism-liveshift-seperator"></div></div><div class="prism-disable-liveshift"></div>',
                a
            },
            bindEvent: function() {
                var a = this;
                ...
                f.on(this.progressNode, "mousemove",
                function(b) {
                    a._progressMove(b)
                }),
                f.on(this.progressNode, "touchmove",
                function(b) {
                    a._progressMove(b)
                }),
                f.on(this._el, "click",
                ...
                f.on(this.progressNode, j.Private.MouseOver,
                function(b) {
                    a._onMouseOver(b)
                }),
                f.on(this.progressNode, j.Private.MouseOut,
                function(b) {
                    a._onMouseOut(b)
                }),
                this.bindTimeupdate = h.bind(this, this._onTimeupdate),
                this._player.on(j.Player.TimeUpdate, this.bindTimeupdate),
                i.isLiveShift(this._player._options) && this._player.on(j.Player.Play,
                function() {
                    a._liveshiftService.start(6e4,
                    function(b) {
                        var c = {
                        ...
                        a._player.logError(c),
                        a._player.trigger(j.Player.Error, c)
                    })
                }),
                this._player.on(j.Private.LiveShiftQueryCompleted,
                function() {
                    a._updateSeperator()
                }),
                this._player.on(j.Player.Pause,
                function() {
            ...
            _updateSeperator: function() {
                ...
                a = a > 1 ? 1 : a,
                e.css(this.progressNode, "width", 100 * a + "%")
            },
            ...
            _onMouseOut: function(a) {
                e.css(this.cursorNode, "display", "none"),
                e.css(this.timeNode, "display", "none")
            },
            ...
            _onMouseClick: function(a) {
                ...
                this._player.loadByUrl(d, c, !0),
                this._player.trigger(j.Private.Play_Btn_Hide),
                this._liveshiftService.seekTime = c,
                b._player.trigger(j.Private.EndStart, {
                    toTime: c
                }),
                this._updateCursorPosition(c)
            },
            ...
            _onMouseMove: function(a) {
                ...
                this._updateProgressBar(this.playedNode, b),
                this._updateCursorPosition(b)
            },
            ...
            _updateProgressBar: function(a, b) {
                if (1 != this._player._switchSourcing) {
                    ...
                    if ( - 1 == this._liveshiftService.seekTime) c = 1;
                        ...
                        b += this._liveshiftService.seekTime,
                        c = d ? b / d: 0,
                        c > 1 && (c = 1, this._liveshiftService.seekTime = -1)
                    }
            ...
            _updateCursorPosition: function(a) {
                if (1 != this._player._switchSourcing) {
                    ...
                    if ( - 1 == this._liveshiftService.seekTime) b = 1;
                        ...
                        a += this._liveshiftService.seekTime,
                        b = c ? a / c: 0,
                        b > 1 && (this._liveshiftService.seekTime = -1)
                    }
                    var d = 1,
                    f = this._player.el().clientWidth;
                    0 != f && (d = 1 - 18 / f),
    ...
    9 : [function(a, b, c) {
        ...
        g = d.extend({
            init: function(a, b) {
                d.call(this, a, b),
                this.className = b.className ? b.className: "prism-live-time-display",
                this.addClass(this.className),
                this._liveshiftService = a._liveshiftService
            },
            createEl: function() {
                var a = d.prototype.createEl.call(this, "div");
                return a.innerHTML = '<span class="current-time">00:00</span> <span class="time-bound">/</span> <span class="end-time">00:00</span><span class="live-text">Live: </span><span class="live-time"></span>',
                a
            },
            bindEvent: function() {
                var a = this;
                ...
                this._player.on(f.Private.LiveShiftQueryCompleted,
                function() {
                    a.updateTime()
                })
            },
    ...
    13 : [function(a, b, c) {
        b.exports = b.exports = {
            ...
            Error_Server_Network_NotSupport_Text: "Network error or Â the format of video is unsupported",
            ...
            Error_H5_Not_Support_Text: "The format of video is not supported byÂ h5 playerï¼Œplease use flash player",
            Error_Not_Support_M3U8_Text: "The format of m3u8 is not supported by this explorer",
            Error_Not_Support_MP4_Text: "The format of mp4Â is not supported by this explorer",
            ...
            Error_Vod_Fetch_Urls_Text: "Error occured when fetch urlsï¼Œplease close or refresh",
            ...
            Error_Load_M3U8_Failed_Text: "TheÂ m3u8 file loaded failed",
            Error_Load_M3U8_Timeout_Text: "Timeout error occoredÂ when theÂ m3u8 file loaded",
            Error_M3U8_Decode_Text: "The m3u8 file decoded failed",
            Error_TX_Decode_Text: "Video decoded failed",
            Error_Waiting_Timeout_Text: "Buffering timeout,Â please close or refresh",
    ...
    14 : [function(a, b, c) {
        b.exports = b.exports = {
            ...
            Default: "Default",
            Contrast: "Contrast",
            Titles_Credits: "TitlesÂ andÂ Credits",
            ...
            Video_Error: "Playing a video error,Â please try to refresh",
            Decode_Error: "Data decodingÂ error",
            Live_Not_Start: "Live has not started, to be expected",
            Live_Loading: "Live information is loading,Â please try to refresh",
            Fetch_Playauth_Error: "Error occured when fetch playauth close or refresh",
            Live_End: "Live has finished",
            Live_Abrot: "Signal aborted,Â please try to refresh",
            Corss_Domain_Error: "Please ensure your domain has obtained IPC license and combined CNAME, \r\n or to setÂ Â cross-domain accessing available",
            Url_Timeout_Error: "The video url is timeout,Â please try to refresh",
            Connetction_Error: "Sorryï¼Œthe video cannot play because of connection error, please try to watch other videos",
            ...
            Auto_Stream_Tip_Text: "Internet is slow, does switch to $$",
            Open_Html_By_File: "Html page should be on the server",
            Cant_Use_Flash_On_Mobile: "Mobile doesn't support flash playerï¼Œplease use h5 player"
        }
    },
    {}],
    15 : [function(a, b, c) {
    ...
    16 : [function(a, b, c) {
        ...
        h = function() {
            if (void 0 === window[g] || !window[g]) {
                ...
                a = a && a.indexOf("zh") > -1 ? "zh-cn": "en-us",
                window[g] = a
            }
            return window[g]
        },
    ...
    19 : [function(a, b, c) {
        ...
        b.exports.DRMKeySystem = {
            4 : "com.microsoft.playready",
            5 : "com.widevine.alpha"
        },
        b.exports.EncryptionType = {
            Private: 1,
            Standard: 2,
            ChinaDRM: 3,
            PlayReady: 4,
    ...
    22 : [function(a, b, c) {
        ...
        b.exports.getTransformName = function(a) {
            var b, c, d = ["transform", "WebkitTransform", "MozTransform", "msTransform", "OTransform"],
            e = d[0];
            for (b = 0, c = d.length; b < c; b++) if (void 0 !== a.style[d[b]]) {
                e = d[b];
                break
            }
            return e
    ...
    23 : [function(a, b, c) {
        ...
        b.exports.trigger = function(a, c) {
            ...
            if ("string" == typeof c) {
                var g = null; (a.paramData || 0 == a.paramData) && (g = a.paramData, a.paramData = null, a.removeAttribute(g)),
                c = {
                    type: c,
                    target: a,
                    paramData: g
    ...
    25 : [function(a, b, c) {
        var d = a("./url");
        b.exports.get = function(a, c, d, e, f) {
        ...
        b.exports.post = function(a, c, d, e, f, g) {
            ...
            b.exports.ajax("POST", a, c, d, e, f, g, h)
        },
        b.exports.ajax = function(a, b, c, e, f, g, h, i) {
            ...
            l = d.parseUrl(b),
            m = window.location,
            n = l.protocol + l.host !== m.protocol + m.host,
            !n || !window.XDomainRequest || "withCredentials" in k ? (j = "file:" == l.protocol || "file:" == m.protocol, k.onreadystatechange = function() {
                4 === k.readyState && (200 === k.status || j && 0 === k.status ? e(k.responseText) : f(k.responseText))
            }) : (k = new window.XDomainRequest, k.onload = function() {
                e(k.responseText)
            },
            k.onerror = f, k.onprogress = function() {},
            k.ontimeout = f);
            try {
                if (void 0 === g && (g = !0), k.open(a, b, g), h && (k.withCredentials = !0), i) for (var o in i) k.setRequestHeader(o, i[o])
            } catch(a) {
                return void f(a)
            }
            try {
    ...
    26 : [function(a, b, c) {
        ...
        b.exports.render = function(a, b) {
            ...
            e = b.x ? b.x: 0,
            f = b.y ? b.y: 0;
            xunit = e.indexOf && e.indexOf("%") > 0 ? "": "px",
            yunit = f.indexOf && f.indexOf("%") > 0 ? "": "px",
            "tl" === c ? d.css(a, {
                float: "left",
                "margin-left": e + xunit,
                "margin-top": f + yunit
    ...
    29 : [function(a, b, c) {
        ...
        b.exports.createWrapper = function(a) {
            var c, d = a.id;
            if ("string" == typeof d ? (0 === d.indexOf("#") && (d = d.slice(1)), c = f.el(d)) : c = d, !c || !c.nodeName) throw new TypeError("æ²¡æœ‰ä¸ºæ’­æ”¾å™¨æŒ‡å®šå®¹å™¨");
        ...
        b.exports.findSelectedStreamLevel = function(a) {
            var b = g.get(h.SelectedStreamLevel);
            if (!b) return g.set(h.SelectedStreamLevel, a[0].definition, 365),
            0;
        ...
        b.exports.handleOption = function(a, c) {
            ...
            g = !1;
            if (a.useFlashPrism || b.exports.isRTMP(a.source)) g = !0,
            f = [{
                name: "liveIco",
                align: "tlabs",
                x: 15,
            ...
            },
            {
                ...
                for (var i = a.skinLayout.length,
                l = [], m = -1, n = 0; n < i; n++) if ("controlBar" == e.skinLayout[n].name) {
                    m = n;
                    for (var o = e.skinLayout[n].children.length, p = 0; p < o; p++) {
                        var q = e.skinLayout[n].children[p].name;
                        if ("liveDisplay" == q || "liveIco" == q || "fullScreenButton" == q || "volume" == q || "snapshot" == q || h && ("progress" == q || "playButton" == q || "timeDisplay" == q)) {
                            var r = e.skinLayout[n].children[p];
                            "progress" == q ? r.name = "liveShiftProgress": "timeDisplay" == q ? r.name = "liveShiftTimeDisplay": g && "liveDisplay" == q && (r.name = "liveIco"),
                            l.push(r)
                        }
                    }
                    break
            ...
            return (void 0 === a.components || !a.components || d.isArray(a.components) && 0 == a.components.length) && (e.components = [j]),
            e
        }
    },
    {
    ...
    31 : [function(a, b, c) {
        ...
        function f() {
            ...
            c = b.exports.browser;
            return c.firefox ? "Firefox": c.webview ? "webview": c.ie ? /edge/.test(a) ? "Edge": "IE": c.chrome ? "Chrome": c.safari ? "Safari": /baiduspider/.test(a) ? "Baiduspider": /ucweb/.test(a) || /UCBrowser/.test(a) ? "UC": /opera/.test(a) ? "Opera": /ucweb/.test(a) ? "UC": /360se/.test(a) ? "360æµè§ˆå™¨": /bidubrowser/.test(a) ? "ç™¾åº¦æµè§ˆå™¨": /metasr/.test(a) ? "æœç‹—æµè§ˆå™¨": /lbbrowser/.test(a) ? "çŒŽè±¹æµè§ˆå™¨": /micromessenger/.test(a) ? "å¾®ä¿¡å†…ç½®æµè§ˆå™¨": /qqbrowser/.test(a) ? "QQæµè§ˆå™¨": /playstation/.test(a) ? "PS4æµè§ˆå™¨": void 0
        }
        ...
        b.exports.IS_IOS = b.exports.IS_IPHONE || b.exports.IS_IPAD || b.exports.IS_IPOD,
    ...
    33 : [function(a, b, c) {
        ...
        b.exports.convertToTimestamp = function(a, b) {
            var c = "";
            return a && (b ? c = a.gettime() : (c = Date.parse(a), c /= 1e3)),
            c
        },
        ...
        b.exports.readyBinary = function(a) {
            for (var b = new Uint8Array(a), c = b.length, d = "", e = 0; e < c; e++) d += b[e];
            return d
        },
    ...
    34 : [function(a, b, c) {
        ...
        p = f.extend({
            init: function(a, b, c) {
                ...
                try {
                    var E = function(a) {
                        ...
                        if (this.trackLog) return j.jsonp("https://cdn.dns-detect.alicdn.com/api/cdnDetectHttps?method=createDetectHttps",
                        function(b) {
            ...
            bindEvent: function() {
                ...
                this.player.on(m.Video.LoadStart,
                function() {
                    a.loadstartTime = (new Date).getTime(),
                    a._onPlayerloadstart()
                }),
                this.player.on(m.Video.LoadedMetadata,
                function() {
                    a._onPlayerLoadMetadata()
                }),
                this.player.on(m.Video.LoadedData,
                function() {
                    a._onPlayerLoaddata()
                }),
                this.player.on(m.Video.Play,
                function() {
                    a._onPlayerPlay()
                }),
                ...
                this.player.on(m.Video.Ended,
                function() {
                    a._onPlayerFinish()
                }),
                this.player.on(m.Video.Pause,
                function() {
                    a._onPlayerPause()
                }),
                ...
                this.player.on(m.Private.EndStart,
                function(b) {
            ...
            _reportPlay: function() {
                return ! (this.buffer_flag || !this.player._options.autoplay || !this._LoadedData) && (this.first_play_time = (new Date).getTime(), this._log("PLAY", {
                    dsm: "fix",
                    vt: 0,
            ...
            _onPlayerPlay: function() {
                this._log("STARTPLAY", {}),
                0 == this.playId && (this.playId = i.guid()),
                this.firstPlay || 0 != this.pause_flag || this.seeking || (this.sessionId = i.guid()),
                this.firstPlay = !1,
    ...
    36 : [function(a, b, c) {
        ...
        i = d.extend({
            init: function(a, b) {
                this._isAudio = !0,
                void 0 === b.skinLayout && (b.skinLayout = h.defaultAudioLayout),
                d.call(this, a, b)
            }
        });
    ...
    50 : [function(a, b, c) {
        ...
        b.exports.handle = function(a) {
            ...
            if (b.waiting = !1, b._checkTimeoutHandle && clearTimeout(b._checkTimeoutHandle), b.checkOnline()) {
                ...
                i = h.error.message,
                g = "";
                if (h.error.code && (c = h.error.code, g = e.VideoErrorCode[h.error.code], i = c + " || " + i), b._options.isLive) b._options.liveRetry > b._liveRetryCount ? b._reloadAndPlayForM3u8() : (b._liveRetryCount = 0, b.trigger(d.Player.LiveStreamStop), b._liveErrorHandle = setTimeout(function() {
                    var a = {
                        mediaId: "ISLIVE",
                        error_code: g,
                        error_msg: f.get("Error_Play_Text") + "ï¼Œ" + f.get("Error_Retry_Text")
                    };
                    b.logError(a),
                    b.trigger("error", a)
                },
                500));
                    ...
                    k = !1;
                    c < 4 ? j = e.VideoErrorCodeText[c] : b._eventState == e.SUSPEND ? (j = f.get("Error_Load_Abort_Text"), g = e.ErrorCode.RequestDataError) : b._eventState == e.LOAD_START ? (j = f.get("Error_Network_Text"), b._options.source.indexOf("auth_key") > 0 && (j = j + "ï¼Œ" + f.get("Error_AuthKey_Text")), g = e.ErrorCode.StartLoadData) : b._eventState == e.LOADED_METADATA && (j = f.get("Error_Play_Text"), g = e.ErrorCode.PlayingError),
                    j = j + "ï¼Œ" + f.get("Error_Retry_Text"),
                    b._urls.length > 1 && b._retrySwitchUrlCount < 3 && -1 == b._options.source.indexOf(".mpd") && (b.switchUrl(), k = !0);
                    var l = {
    ...
    55 : [function(a, b, c) {
        ...
        b.exports.handle = function(a) {
            var b = this;
            b.trigger(d.Player.TimeUpdate, a.timeStamp),
            b.trigger(d.Private.H5_Loading_Hide),
            b.trigger(d.Private.H5_Loading_Hide),
            b.trigger(d.Private.AutoStreamHide)
        }
    ...
    57 : [function(a, b, c) {
        ...
        z = d.extend({
            init: function(a, b) {
                ...
                this), this.fullscreenService = new x(this), m.isLiveShift(b) && (this._liveshiftService = new y(this)), this.UI = {},
                b.useNativeControls ? this.tag.setAttribute("controls", "controls") : this.UI = h, this.initChildren(), r.onAll(this), this._lifeCycleManager = new w(this), this._monitor = new i(this, {
                    video_id: 0,
                    album_id: 0,
                ...
                this._options.trackLog), this.checkOnline()) {
                    if (this._overrideNativePlay(), this._liveshiftService && !this._liveshiftService.validate()) {
                        ...
                        return void this.trigger(v.Player.Error, c)
                    }
                    ...
                    if (this._options.extraInfo) {
                        var j = this._options.extraInfo;
                        j.liveRetry && (this._options.liveRetry = j.liveRetry)
                    }
                    this.on(v.Private.ReadyState,
                    function() {
        ...
        z.prototype.initChildren = function() {
            ...
            this.UI.playanimation = t,
            this.addChild("playanimation", a),
            this.UI.autoStreamSelector = u,
            this.addChild("autoStreamSelector", a),
            this.trigger(v.Private.UiH5Ready)
        },
        z.prototype.createEl = function() {
            ...
            var b = this._el,
            c = this.tag;
            this._options.enableSystemMenu || (c.addEventListener ? c.addEventListener("contextmenu",
            function(a) {
                a.preventDefault()
            },
            !1) : c.attachEvent("oncontextmenu",
            function() {
            ...
            this.setVideoAttrs(),
            a || (c.parentNode && c.parentNode.insertBefore(b, c), f.insertFirst(c, b)),
            b
        },
        z.prototype.setVideoAttrs = function() {
            var a = this._options.preload,
            b = this._options.autoplay;
            if (this.tag.style.width = this._options.videoWidth || "100%", this.tag.style.height = this._options.videoHeight || "100%", a && this.tag.setAttribute("preload", "preload"), b && this.tag.setAttribute("autoplay", "autoplay"), this._options.extraInfo) for (var c in this._options.extraInfo) this.tag.setAttribute(c, this._options.extraInfo[c]);
            n.adaptX5Play(this)
        },
        ...
        z.prototype.renderUI = function() {},
        z.prototype.switchUrl = function() {
            if (0 != this._urls.length) {
                ...
                this.trigger(v.Private.QualityChange, p.get("Quality_Change_Fail_Switch_Text"));
                this.getCurrentTime();
        ...
        z.prototype.getMetaData = function() {
            ...
            b = window.setInterval(function(d) {
                ...
                if (c.readyState > 0) {
                    ...
                    a.tag.duration = e,
                    a.trigger(v.Private.ReadyState),
                    clearInterval(b)
                }
            },
            100)
        ...
        z.prototype.play = function() {
            ...
            a.trigger(v.Private.Cover_Hide),
            this.tag.play(),
            this
        },
        ...
        z.prototype.seek = function(a) {
            ...
            var b = this._originalPlaybackRate || this.tag.playbackRate;
            try {
                var c = this;
        ...
        z.prototype.firstNewUrlloadByUrl = function(a, b) {
            ...
            this.initPlay(),
            (this._options.preload || this._options.autoplay) && this.trigger(v.Private.Cover_Hide),
            this._options.autoplay ? this.trigger(v.Player.Play) : this.trigger(v.Player.Pause),
            b || (b = 0),
            !b && 0 != b || isNaN(b) || this.seek(b)
        },
        z.prototype.loadByUrl = function(a, b, c) {
            this._clearLiveErrorHandle(),
            this.trigger(v.Private.Error_Hide),
            this._options.vid = 0,
            this._options.source = a,
            this._monitor && this._monitor.updateVideoInfo({
                video_id: 0,
            ...
            this.initPlay(c),
            (this._options.preload || this._options.autoplay) && this.trigger(v.Private.Cover_Hide),
            this._options.autoplay || c ? this.trigger(v.Player.Play) : this.trigger(v.Player.Pause);
            var d = this;
            g.one(this.tag, v.Video.CanPlay,
            function(a) { ! b && 0 != b || isNaN(b) || d.seek(b)
            })
        },
        z.prototype.dispose = function() {
            this.trigger(v.Private.Dispose),
            this.tag.pause(),
            r.offAll(this),
            this.tag = null,
            this._options = null,
        ...
        z.prototype._muteInner = function() {
            this.tag.muted = !0,
            this.trigger(v.Private.VolumnChanged, -1)
        },
        ...
        z.prototype._unMuteInner = function() {
            this.tag.muted = !1,
            this.trigger(v.Private.VolumnChanged, -2)
        },
        ...
        z.prototype.setVolume = function(a, b) {
            0 != a ? this._unMuteInner() : 0 == a && this._muteInner(),
            this._setInnerVolume(a);
            var c = p.get("Curent_Volume") + "<span>" + (100 * a).toFixed() + "%</span>";
        ...
        z.prototype._setInnerVolume = function(a) {
            this.tag.volume = a,
            this.trigger(v.Private.VolumnChanged, a)
        },
        ...
        z.prototype._setTransform = function() {
            this._transformProp || (this._transformProp = f.getTransformName(this.tag));
            var a = " translate(-50%, -50%)";
            this._rotate && (a += " rotate(" + this._rotate + "deg)"),
            this._image && ("vertical" == this._image ? a += " scaleY(-1)": "horizon" == this._image && (a += " scaleX(-1)")),
            this.tag.style[this._transformProp] = a
        },
        z.prototype._initPlayBehavior = function(a, b) {
            ...
            if (!m.validateSource(b)) {
                ...
                this.trigger(v.Player.Error, c),
                !1
            }
            return this.trigger(v.Private.H5_Loading_Hide),
            void 0 === a && (a = !1),
            this._created || (this._created = !0, this.trigger(v.Private.Created)),
            this.loaded || this.trigger(v.Player.Init),
            (this._options.autoplay || this._options.preload || a) && (this._initLoad(b), this._options.autoplay || this._options._autoplay ? this.tag.play() : this.trigger(v.Private.Play_Btn_Show)),
            !0
        },
        z.prototype._initLoad = function(a) {
            this._options.autoplay && this.trigger(v.Private.H5_Loading_Show),
            this.getMetaData(),
        ...
        z.prototype._checkSupportVideoType = function() {
            ...
            b = "";
            if (a.indexOf("m3u8") > 0 ? "" != this.tag.canPlayType("application/x-mpegURL") || m.isSupportHls() || (b = p.get("Error_Not_Support_M3U8_Text")) : a.indexOf("mp4") > 0 ? "" == this.tag.canPlayType("video/mp4") && (b = p.get("Error_Not_Support_MP4_Text")) : (m.isRTMP(a) || m.isFlv(a)) && j.IS_MOBILE && (b = p.get("Error_Not_Support_Format_On_Mobile")), b) {
                var c = {
                    mediaId: this._options.vid ? this._options.vid: "",
        ...
        z.prototype._overrideNativePlay = function() {
            ...
            this.tag.play = function() {
                if (!b._options.source) {
                    ...
                    return c.display_msg = p.get("Error_Invalidate_Source"),
                    void b.trigger(v.Player.Error, c)
                }
                b.readyTime = (new Date).getTime();
                var d = a.apply(b.tag);
                void 0 !== d && d.
                catch(function(a) {
                    b.trigger(v.Private.Play_Btn_Show),
                    b.trigger(v.Player.AutoPlayPrevented)
                }).then(function() {});
                var e = b._originalPlaybackRate || b.tag.playbackRate;
                setTimeout(function() {
        ...
        z.prototype._extraMultiSources = function() {
            ...
            if (a && a.indexOf("{") > -1 && a.indexOf("}") > -1) {
                ...
                try {
                    ...
                    console.error(a),
                    console.error("åœ°å€jsonä¸²æ ¼å¼ä¸å¯¹")
                }
                var c = [];
                for (var d in b) {
                    var e = k.QualityLevels[d];
                    c.push({
                        definition: d,
                        Url: b[d],
                        desc: e || d
                ...
                if (c.length > 0) {
                    this._currentPlayIndex = m.findSelectedStreamLevel(c);
                    var f = c[this._currentPlayIndex];
                    this._urls = c,
                    this._options.source = f.Url,
                    this.trigger(v.Private.SourceLoaded, f)
                }
            }
        },
        b.exports = z
        ...
        t = d.extend({
            init: function(a, b) {
                if (void 0 === b.skinLayout && (b.skinLayout = l.defaultFlashLayout), d.call(this, this, b), this._id = "prism-player-" + e.guid(), this.tag = a, this._el = this.tag, this._childrenUI = [n, o], this.initChildren(), this.id = this._id, window[this.id] = this, k.setCurrentLanguage(this._options.language, "flash"), m.openInFile()) {
                    var c = {
                        mediaId: this._options.vid ? this._options.vid: "",
                        error_code: g.ErrorCode.FormatNotSupport,
                        error_msg: k.get("Open_Html_By_File", "flash")
                    };
                    return void this.trigger(r.Private.Error_Show, c)
                }
                if (f.IS_MOBILE) return void this.trigger(r.Private.Error_Show, {
                    mediaId: this._options.vid ? this._options.vid: "",
                    error_code: g.ErrorCode.FormatNotSupport,
                    error_msg: k.get("Cant_Use_Flash_On_Mobile", "flash")
                });
                if (this._options.vid && this._options.accessKeyId && this._options.securityToken && this._options.accessKeySecret) {
                    var h = this;
                    s.getPlayAuth(this._options,
                    function(a) {
                        h._options.playauth = a,
                        h._createPlayer()
                    },
                    function(a) {
                        var b = {
                            mediaId: h._options.vid,
                            error_code: a.Code,
                            error_msg: a.Message
                        };
                        a.sri && (b.sri = a.sri),
                        b.display_msg = a.display_msg,
                        h.trigger(r.Private.Error_Show, b)
                    },
                    "flash")
            ...
            _createPlayer: function() {
                if (this._options.autoPlayDelay) {
                    ...
                    a.handle(function() {
                        ...
                        b._initPlayer(),
                        b._childrenUI.push(q),
                        b.initChildren()
                    })
                } else this._initPlayer(),
                this._childrenUI.push(q),
                this.initChildren()
            },
            ...
            _comboFlashVars: function() {
                ...
                g = {
                    ...
                    statisticService: e.statisticService ? e.statisticService: j.logReportTo,
                ...
                h = [];
                return e.cover && (g.cover = e.cover),
                e.extraInfo && (g.extraInfo = encodeURIComponent(JSON.stringify(e.extraInfo))),
                g.logInfo && (g.logInfo = encodeURIComponent(JSON.stringify(g.logInfo))),
                g.languageData = encodeURIComponent(JSON.stringify(k.getLanguageData("flash"))),
                g.language = k.getCurrentLanguage(),
                i.each(g,
                function(a, b) {
                    h.push(a + "=" + b)
                }),
            ...
            flashReady: function() {
                ...
                if (!1 !== c && !i.isArray(c)) throw new Error("PrismPlayer Error: skinLayout should be false or type of array!");
            ...
            _invoke: function() {
                var a = arguments[0],
                b = arguments;
                if (Array.prototype.shift.call(b), !this.flashPlayer) throw new Error("PrismPlayer Error: flash player is not readyï¼Œplease use api after ready event occured!");
        ...
        b.exports.inject = function(a, b, c, d, e, h) {
            ...
            if (h || l(a, n)) {
                ...
                b.prototype.play = function() {
                    ...
                    var a = this;
                    if (a.trigger(k.Private.Cover_Hide), 0 == this._seeking) {
                        var b = 0;
                        this.tag.ended || (b = this.getCurrentTime()),
                        this.seek(b)
                    }
                    return this.tag.paused && (a._hasLoaded || (this.getMetaData(), this._flv.load()), this._flv.play()),
                    this
                },
                ...
                b.prototype.initPlay = function(a) {
                    function b(a, b) {
                        ...
                        d),
                        o(a, a._flv),
                        a._initPlayBehavior(b) && (a._flv.attachMediaElement(a.tag), (a._options.preload || a._options.autoplay) && (a._hasLoaded = !0, a._flv.load()), a._options.autoplay && a._flv.play(), e && e(a._flv))
                    }
                    if (i.browser.safari && this.trigger(k.Private.Snapshot_Hide), g.contentProtocolMixed(n)) {
                        ...
                        return c.display_msg = j.get("Request_Block_Text"),
                        void this.trigger(k.Player.Error, c)
                    }
                    that = this,
                    this._isLoadedFlv ? buildHls(this, a) : (this.trigger(k.Private.H5_Loading_Show), m.call(that,
                    function() {
                        this.trigger(k.Private.H5_Loading_Hide),
                        this._isLoadedFlv = !0,
                        b(this, a)
                    }))
                },
            ...
            if (h || k(a, m, n)) {
                ...
                b.prototype.initPlay = function(a) {
                    ...
                    if (g.contentProtocolMixed(m)) {
                        ...
                        return c.display_msg = i.get("Request_Block_Text"),
                        void this.trigger(j.Player.Error, c)
                    }
                    that = this,
                    this._isLoadedHls ? b(this, a) : (this.trigger(j.Private.H5_Loading_Show), l.call(that,
                    function() {
                        this.trigger(j.Private.H5_Loading_Hide),
                        this._isLoadedHls = !0,
                        b(this, a)
                    }))
                },
                    ...
                    function(b, c) {
                        if (c.details != Hls.ErrorDetails.FRAG_LOOP_LOADING_ERROR && 1 != a._seeking && (0 != c.fatal || c.type == Hls.ErrorTypes.NETWORK_ERROR)) {
                            ...
                            if (c.details == Hls.ErrorDetails.MANIFEST_LOAD_ERROR) {
                                h = !0;
                                c.networkDetails;
                                "404" == c.response.code ? (d = f.ErrorCode.NotFoundSourceURL, e = i.get("Error_Not_Found")) : "403" == c.response.code ? (d = f.ErrorCode.AuthKeyExpired, e = i.get("Error_AuthKey_Text")) : "0" == c.response.code && navigator.onLine ? (d = f.ErrorCode.RequestDataError, e = e + "ï¼Œ" + i.get("Maybe_Cors_Error")) : e = i.get("Error_Load_M3U8_Failed_Text")
    ...
    69 : [function(a, b, c) {
        function d(a, b, c, d) {
            ...
            p = "https://mts." + a.domainRegion + ".aliyuncs.com/?" + o;
            f.get(p,
            function(a) {
                if (a) {
                    var f = JSON.parse(a),
                ...
                } else d && d(i.createError("MPSèŽ·å–å–æ•°å¤±è´¥"))
            },
            function(a) {
                if (d) {
                    var b = {
                        Code: "",
                        Message: j.get("Error_MTS_Fetch_Urls_Text")
                    };
                    try {
                        b = JSON.parse(a)
                    } catch(a) {}
        ...
        function e(a, b) {
            for (var c = [], d = [], e = [], f = a.length - 1; f >= 0; f--) {
                var g = a[f];
                "mp4" == g.format ? d.push(g) : "mp3" == g.format ? e.push(g) : c.push(g)
            }
        ...
        k = function(a, b) {
            ...
            e = 0; e < d; e++) {
                ...
                i = "";
                i = void 0 === h ? f.bitrate: c == h ? h + f.bitrate: h,
                f.desc = i,
                c = h
            }
        };
    ...
    71 : [function(a, b, c) {
        ...
        m = d.extend({
            init: function(a, b) {
                ...
                "mp3" == b.format ? (b.height = "auto", b.mediaType = "audio", d.prototype.createEl = e.prototype.createEl, e.call(this, a, b)) : d.call(this, a, b)
            }
        });
        m.prototype.loadData = function(a) {
            ...
            function(a) {
                if (c.log("COMPLETEFETCHDATA", {
                    cost: (new Date).getTime() - b
                }), a.urls && 0 == a.urls.length) return void c._mtsError_message(c, {
                    Code: f.ErrorCode.URLsIsEmpty,
                    Message: j.get("Error_Vod_URL_Is_Empty_Text")
                },
                "");
                c._urls = a.urls,
                c._currentPlayIndex = k.findSelectedStreamLevel(c._urls);
                var e = a.urls[c._currentPlayIndex],
                g = e.Url;
                c._options.source = g,
                k.isHls(g) ? h.inject(c, m, d.prototype, c._options) : k.isFlv(g) && i.inject(c, m, d.prototype, c._options),
                c._authKeyExpiredHandle.tick(f.AuthKeyRefreshExpired),
                c.trigger(l.Private.SourceLoaded, e),
                c.initPlay()
            },
            function(a) {
        ...
        m.prototype._mtsError_message = function(a, b, c) {
            ...
            b.sri && (k.sri = b.sri),
            d.logError(k),
            k.display_msg = h || j.get("Error_Vod_Fetch_Urls_Text"),
            d.trigger("error", k),
    ...
    72 : [function(a, b, c) {
        ...
        b.exports.makeChangeSiga = function(a, c, f) {
            if (!a) throw new Error("PrismPlayer Error: vid should not be null!");
            return f || (f = "GET"),
            e.stringify(d(f + "&" + b.exports.AliyunEncodeURI("/") + "&" + b.exports.AliyunEncodeURI(b.exports.makeUTF8sort(a, "=", "&")), c + "&"))
        },
        ...
        b.exports.encPlayAuth = function(a) {
            ...
            if (!a) throw new Error("playuthå‚æ•°è§£æžä¸ºç©º");
            return JSON.parse(a)
        },
        ...
        i = function(a, b, c, i) {
            ...
            function(a) {
                if (a) {
                    var d = JSON.parse(a);
                    b && b(d.PlayAuth)
                } else c && c(g.createError("èŽ·å–è§†é¢‘æ’­æ”¾å‡­è¯å¤±è´¥"))
            },
            function(a) {
                if (c) {
                    var b = JSON.parse(a);
    ...
    75 : [function(a, b, c) {
        function d(a, b, c, d) {
            ...
            q = "https://vod.cn-shanghai.aliyuncs.com/?" + p;
            f.get(q,
            function(a) {
                if (a) {
                    var f = JSON.parse(a),
                ...
                } else d && d(i.createError("ç‚¹æ’­æœåŠ¡èŽ·å–å–æ•°å¤±è´¥"))
            },
            function(a) {
                if (d) {
                    var b = {
                        Code: "",
                        Message: k.get("Error_Vod_Fetch_Urls_Text")
                    };
                    try {
                        b = JSON.parse(a)
                    } catch(a) {}
    ...
    76 : [function(a, b, c) {
        ...
        i = d.extend({
            init: function(a, b) {
                ...
                this.service = f;
                var c = this;
                this._options.accessKeyId && this._options.securityToken && this._options.accessKeySecret ? h.getPlayAuth(this._options,
                function(a) {
                    c._options.playauth = a,
                    c.loadByVod()
                },
                function(a) {
                    c._mtsError_message(c, a, "")
        ...
        i.prototype.updateSourcesByVidAndPlayAuth = function(a, b) {
            if (a != this._options.vid) return void console.log("ä¸èƒ½æ›´æ–°åœ°å€ï¼Œvidå’Œæ’­æ”¾ä¸­çš„ä¸ä¸€è‡´");
            this._options.vid = a,
            this._options.playauth = b;
            try {
                var c = g.encPlayAuth(this._options.playauth)
            } catch(a) {
                return void console.log("playauthè§£æžé”™è¯¯")
            }
            var d = {
                vid: a,
    ...
    77 : [function(a, b, c) {
        ...
        k.prototype.requestFullScreen = function() {
            ...
            b[a.requestFn](),
            c._player.trigger(g.Player.RequestFullScreen),
            this;
            this.isFullScreen = !0,
            this.isFullScreenChanged = !1,
            this._requestFullScreenTimer = null,
    ...
    78 : [function(a, b, c) {
        ...
        k = function(a) {
            this._player = a,
            this._originalPlayUrl = a._options.source,
            this._liveShiftUrl = a._options.liveTimeShiftUrl,
            this.liveTimeRange = i(a._options.liveStartTime, a._options.liveOverTime),
        ...
        k.prototype.getTimeline = function(a, b) {
            if (this._liveShiftUrl) {
                ...
                function(d) {
                    if (d) {
                        var e = d;
                        0 == e.retCode ? (j(c, e.content.current), c._player.trigger(h.Private.LiveShiftQueryCompleted), a && a()) : b({
                            Code: g.ErrorCode.ServerAPIError,
                            Message: e.retCode + "|" + e.description + "|" + e.content
                        })
                    } else console.log("èŽ·å–ç›´æ’­æ—¶ç§»æ•°æ®å¤±è´¥")
                },
                function(a) {
                    if (b && a) {
                        var c = {};
                        if (a) {
                            if (a.indexOf("403 Forbidden") > -1) c.Code = g.ErrorCode.AuthKeyExpired,
                            c.Message = "Query liveshift failed:" + f.get("Error_AuthKey_Text");
                            else {
                                var d, c = a;
                                try {
                                    d = JSON.parse(a)
                                } catch(a) {}
                                d && (c.Code = g.ErrorCode.ServerAPIError, c.Message = d.retCode + "|" + d.description + "|" + d.content)
                            }
                            b(c)
                        }
                    }
        ...
        k.prototype.tickLocalLiveTime = function() {
            ...
            b = function() {
                a._localLiveTimeHandler = setTimeout(function() {
                    a.currentTimestamp++,
                    j(a, a.currentTimestamp),
                    a._player.trigger(h.Private.LiveShiftQueryCompleted),
                    b()
                },
                1e3)
            };
        ...
        k.prototype.setLiveTimeRange = function(a, b) {
            a || (a = this._player._options.liveStartTime),
            b || (b = this._player._options.liveOverTime),
            this.liveTimeRange = i(a, b),
            j(this, this.currentTimestamp),
            this._player.trigger(h.Private.LiveShiftQueryCompleted)
        },
    ...
    80 : [function(a, b, c) {
        ...
        l.prototype.trigger = function(a, b) {
            return (b || 0 == b) && (this._el.paramData = b),
            this._eventState = a,
    ...
    82 : [function(a, b, c) {
        ...
        f = d.extend({
            ...
            createEl: function() {
                var a = d.prototype.createEl.call(this);
                return a.innerHTML = '<div id=videokongzhi class="prism-controlbar-bg"></div>',
                a
            },
            onEvent: function() {
                var a = this.player(),
    ...
    84 : [function(a, b, c) {
        ...
        k = d.extend({
            ...
            createEl: function() {
                var a = d.prototype.createEl.call(this, "div");
                return a.innerHTML = "<div class='prism-error-content'><p></p></div><div class='prism-error-operation'><a class='prism-button prism-button-refresh' type='button'>" + i.get("Refresh_Text") + "</a><a class='prism-button prism-button-orange'  target='_blank'>" + i.get("Detection_Text") + "</a></div><div class='prism-detect-info prism-center'><p class='errorCode'><span class='info-label'>codeï¼š</span><span class='info-content'></span></p><p class='vid'><span class='info-label'>vidï¼š</span><span class='info-content'></span></p><p class='uuid'><span class='info-label'>uuidï¼š</span><span class='info-content'></span></p><p class='requestId'><span class='info-label'>requestIdï¼š</span><span class='info-content'></span></p><p class='dateTime'><span class='info-label'>" + i.get("Play_DateTime") + "ï¼š</span><span class='info-content'></span></p></div>",
                a
            },
            bindEvent: function() {
                var a = this;
                ...
                function(b) {
                    var c = null;
                    a._player.getMonitorInfo && (c = a._player.getMonitorInfo()),
                    a._show(b, c)
                }),
            ...
            _show: function(a, b) {
                ...
                document.querySelector("#" + this.id() + " .prism-error-content p").innerHTML = k,
        ...
        f = d.extend({
            ...
            bindEvent: function() {
                ...
                function() {
                    ...
                    播放器全屏(a._player.fullscreenService.getIsFullScreen());
                }) 
            }
        });
        b.exports = f
    ...
    89 : [function(a, b, c) {
        ...
        g = d.extend({
            init: function(a, b) {
                d.call(this, a, b),
                this.addClass(b.className || "prism-animation")
            },
            bindEvent: function() {
                var a = this;
                this._player.on(e.Player.Play,
                function() {
                    a.removeClass("prism-pause-animation"),
                    a.addClass("prism-play-animation"),
                    a.removeClass("play-apply-animation"),
                    setTimeout(function() {
    ...
    91 : [function(a, b, c) {
        ...
        l = d.extend({
            ...
            createEl: function() {
                var a = d.prototype.createEl.call(this);
                return a.innerHTML = '<div class="prism-progress-loaded"></div><div class="prism-progress-played"></div><div class="prism-progress-cursor"></div><p class="prism-progress-time"></p>',
                a
            },
            bindEvent: function() {
                var a = this;
                ...
                this._player.on(k.Private.HideProgress,
                function(b) {
                    a._hideProgress(b)
                }),
                this._player.on(k.Private.CancelHideProgress,
                function(b) {
                    a._cancelHideProgress(b)
                }),
                f.on(b, k.Private.MouseOver,
                function(b) {
                    a._onMouseOver(b)
                }),
                f.on(b, k.Private.MouseOut,
                function(b) {
                    a._onMouseOut(b)
                }),
                f.on(this.controlNode, k.Private.MouseLeave,
                function(b) {
                    a._offMouseUp()
                }),
                this.bindTimeupdate = h.bind(this, this._onTimeupdate),
                this._player.on(k.Player.TimeUpdate, this.bindTimeupdate),
                g.IS_IPAD ? this.interval = setInterval(function() {
                    a._onProgress()
                },
                500) : this._player.on(k.Video.Progress,
                function() {
                    a._onProgress()
                })
            },
            _progressMove: function(a) {
                ...
                c > f && (c = f),
                this.cursorNode && e.css(this.timeNode, "left", 100 * c + "%")
            },
            _hideProgress: function(a) {
                f.off(this.cursorNode, "mousedown"),
                f.off(this.cursorNode, "touchstart")
            ...
            _onMouseOut: function(a) {
                ...
                this._cursorHideHandler = setTimeout(function() {
                    e.css(b.cursorNode, "display", "none"),
                    e.css(b.timeNode, "display", "none"),
                    b._mouseInProgress = !1
                })
            },
            _getSeconds: function(a) {
                for (var b = this.el().offsetLeft, c = this.el(); c = c.offsetParent;) b += c.offsetLeft;
            ...
            _onMouseClick: function(a) {
                ...
                this._player.seek(b),
                this._player.trigger(k.Private.EndStart, {
                    toTime: b
                }),
                this._updateCursorPosition(b)
            },
            ...
            _onMouseMove: function(a) {
                a.preventDefault();
                var b = this._getSeconds(a);
                this._player._hls || (this._player.seek(b), this._player.play()),
                this._updateProgressBar(this.playedNode, b),
                this._updateCursorPosition(b)
            },
            _onTimeupdate: function(a) {
                this._updateProgressBar(this.playedNode, this._player.getCurrentTime()),
                this._updateCursorPosition(this._player.getCurrentTime()),
                this._player.trigger(k.Private.UpdateProgressBar, {
                    time: this._player.getCurrentTime()
                })
            },
            _onProgress: function(a) {
            ...
            _updateCursorPosition: function(a) {
                if (1 != this._player._switchSourcing) {
                    ...
                    c = 1,
                    d = this._player.el().clientWidth;
                    0 != d && (c = 1 - 18 / d),
                    this.cursorNode && (b > c ? (e.css(this.cursorNode, "right", "0px"), e.css(this.cursorNode, "left", "auto")) : (e.css(this.cursorNode, "right", "auto"), e.css(this.cursorNode, "left", 100 * b + "%")))
                }
            }
        });
        b.exports = l
    ...
    92 : [function(a, b, c) {
        ...
        h = d.extend({
            ...
            bindEvent: function() {
                var a = this;
                this._player.on(g.Private.Snapshot_Hide,
                function() {
                ...
                function() {
                    ...
                    k = b.getContext("2d");
                    k.save();
                    var l = a._player.getImage();
                    "vertical" == l ? (k.translate(0, b.height), k.scale(1, -1)) : "horizon" == l && (k.translate(b.width, 0), k.scale( - 1, 1)),
                    ...
                    p = "",
                    q = "";
                    m && (o = m, p = o.substr(o.indexOf(",") + 1), q = f.toBinary(p)),
                    a.trigger(g.Player.Snapshoted, {
                        time: j,
                        base64: o,
                        binary: q,
                        error: n
    ...
    93 : [function(a, b, c) {
        ...
        l = d.extend({
            ...
            createEl: function() {
                var a = d.prototype.createEl.call(this, "div");
                return a.innerHTML = '<div class="current-speed-selector" key="1">' + j.get("Speed_Text") + '</div><ul class="speed-selector-list"></ul>',
                a
            },
            bindEvent: function() {
                var a = this,
                ...
                this._player.on(k.Private.SpeedSelectorHide,
                function() {
                    d()
                }),
                h.on(b, "click",
                function() {
                    ...
                    a._isShown && a._player.trigger(k.Private.StreamSelectorHide);
                    else {
                        var d = i.SpeedLevels;
                        e.each(d,
                        function(d, e) {
                        ...
                        g.css(c, "display", "block"),
                        a._player.trigger(k.Private.StreamSelectorHide)
                    }
                }),
                h.on(c, "click",
                function(b) {
    ...
    94 : [function(a, b, c) {
        ...
        m = d.extend({
            ...
            createEl: function() {
                var a = d.prototype.createEl.call(this, "div");
                return a.innerHTML = '<div class="current-stream-selector">' + k.get("SD") + '</div><ul class="stream-selector-list"></ul>',
                a
            },
            ...
            bindEvent: function() {
                ...
                this._player.on(l.Private.StreamSelectorHide,
                function() {
                    d()
                }),
                i.on(c, "mouseenter",
                ...
                function() {
                    ...
                    a._isShown = !a._isShown,
                    a._isShown && a._player.trigger(l.Private.SpeedSelectorHide);
                    else {
                        ...
                        function(b, d) {
                            ...
                            a._hasGeneratedList = !0,
                            h.css(c, "display", "block"),
                            a._player.trigger(l.Private.SpeedSelectorHide)
                        })
                    }
                }),
                i.on(c, "click",
                function(b) {
                    ...
                    if (void 0 !== l) {
                        ...
                        h.css(c, "display", "none"),
                        a._isShown = !1,
                        a.showTip(k.get("Quality_Change_Text") + "<span>" + l + "</span>", 2e3),
                        setTimeout(function() {
    ...
    96 : [function(a, b, c) {
        ...
        h = d.extend({
            ...
            createEl: function() {
                var a = d.prototype.createEl.call(this, "div");
                return a.innerHTML = '<div class="volume-icon"></div> <div class="volume-control"><div class="volume-range"><div class="volume-value"></div><div class="volume-cursor"></div></div><div class="volume-control-icon"></div></div>',
                a
            },
            bindEvent: function() {
                var a = this;
                this.icon = document.querySelector("#" + a.id() + "  .volume-icon"),
                this.controlicon = document.querySelector("#" + a.id() + "  .volume-control-icon"),
                this.control = document.querySelector("#" + a.id() + "  .volume-control"),
                this.volumnValue = document.querySelector("#" + a.id() + "  .volume-value"),
                this.volumnRange = document.querySelector("#" + a.id() + "  .volume-range"),
                this.volumnCursor = document.querySelector("#" + a.id() + "  .volume-cursor"),
                f.on(this.control, "mouseenter",
                function() {
                    e.css(a.control, "display", "block"),
                    a._shown = !0
                }),
                f.on(this.icon, "mouseleave",
                function() {
                    setTimeout(function() {
                ...
                f.on(this.icon, "click",
                function() {
                    if (a._shown) e.css(a.control, "display", "none"),
                    a._shown = !1;
                    else {
                ...
                function(b) {
                    ...
                    a._setVolumnUI(c),
                    a._setMuteUI(c),
                    a._player.setVolume(c)
                }),
                f.on(this.controlicon, "click",
                function(b) {
                    a._player.muted() ? a._player.unMute() : a._player.mute()
                }),
                f.on(this.volumnCursor, "mousedown",
                function(b) {
                    a._onMouseDown(b)
                }),
                f.on(this.volumnCursor, "touchstart",
                function(b) {
                    a._onMouseDown(b)
                }),
                this._player.on(g.Private.VolumnChanged,
                function(b) {
                    var c = b.paramData;
                    c > -1 && a._setVolumnUI(c),
                    a._setMuteUI(c)
                }),
                f.on(this.control, "mouseleave",
                function() {
                    e.css(a.control, "display", "none"),
                    a._shown = !1
                }),
                f.on(this.control, "mouseover",
                function() {
            ...
            _onMouseDown: function(a) {
                var b = this;
                a.preventDefault(),
                f.on(this.control, "mousemove",
                function(a) {
                    b._onMouseMove(a)
                }),
                f.on(this.control, "touchmove",
                function(a) {
                    b._onMouseMove(a)
                }),
                f.on(this._player.tag, "mouseup",
                ...
                f.on(this.control, "mouseup",
                function(a) {
                    b._onMouseUp(a)
                }),
                f.on(this.control, "touchend",
                function(a) {
                    b._onMouseUp(a)
                })
            },
            ...
            _offEvent: function() {
                f.off(this._player.tag, "mouseup"),
                f.off(this._player.tag, "touchend"),
                f.off(this.control, "mousemove"),
                f.off(this.control, "touchmove"),
                f.off(this.control, "mouseup"),
                f.off(this.control, "touchend")
            },
